...
export const APP_TITLE =
  process.env.NEXT_PUBLIC_APP_TITLE ?? "SaaS Tenant Dashboard";

/** Meta description — set `NEXT_PUBLIC_APP_DESCRIPTION` in `.env` */
export const APP_DESCRIPTION =
  process.env.NEXT_PUBLIC_APP_DESCRIPTION ?? "SaaS tenant management dashboard";
...
/** Tenant organization subdomain — used to identify the tenant during login */
export const TENANT_SUBDOMAIN =
  process.env.NEXT_PUBLIC_TENANT_SUBDOMAIN ?? "";
