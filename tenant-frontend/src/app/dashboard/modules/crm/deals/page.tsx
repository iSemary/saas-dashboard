    ...
    <div className="space-y-4">
      <div className="rounded-xl border bg-muted/40 p-4">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-xl font-semibold">{t("dashboard.crm.deals", "Deals")}</h1>
        </div>
        <p className="mt-1 text-sm text-muted-foreground">{t("dashboard.crm.deals_subtitle", "Track your CRM deals")}</p>
      </div>
      <Card>
