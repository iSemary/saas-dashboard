...
Route::prefix('landlord')->name('landlord.')->middleware(['auth:web', 'role:landlord', '2fa'])->group(function () {
    ...
    Route::get('translations/generate-json', [TranslationController::class, 'generateJson'])->name('translations.generate-json');
    Route::get('translations/sync-missing', [TranslationController::class, 'syncMissing'])->name('translations.sync-missing');
