...
class TicketController extends ApiController implements HasMiddleware
{
    ...
    public function index()
    {
        ...
        $actionButtons = [
            [
                ...
                'attr' => [
                    'href' => route('landlord.tickets.create'),
                ]
            ],
            [
                ...
                'attr' => [
                    'href' => route('landlord.tickets.kanban'),
                ]
            ],
        ];
    ...
    public function show($id)
    {
        ...
        $breadcrumbs = [
            ['text' => translate('home'), 'link' => route('home')],
            ['text' => translate('tickets'), 'link' => route('landlord.tickets.index')],
    ...
    public function edit($id)
    {
        ...
        if (!$row) {
            return redirect()->route('landlord.tickets.index')
    ...
    public function kanban()
    {
        ...
        $actionButtons = [
            [
                ...
                'class' => 'btn btn-info btn-sm',
                'attr' => [
                    'href' => route('landlord.tickets.index'),
                ]
            ],
            [
                'text' => translate("create") . " " . translate($this->service->model->singleTitle),
