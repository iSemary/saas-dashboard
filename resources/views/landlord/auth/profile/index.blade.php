            ...
            <div class="tab-content" id="profileTabsContent">
                ...
                <div class="tab-pane fade show active" id="general" role="tabpanel" aria-labelledby="general-tab">
                    <form action="{{ route('landlord.profile.update') }}" class="edit-form" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3 w-100">
                                    <label for="phone" class="form-label">@translate('phone') <span
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    <label for="address" class="form-label">@translate('address') <span
                                            class="text-danger">*</span></label>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="translationValue" class="form-label">@translate('language') <span
                                            class="text-danger">*</span></label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="country_id" class="form-label">@translate('country') <span
                                            class="text-danger">*</span></label>
                ...
                <div class="tab-pane fade" id="security" role="tabpanel" aria-labelledby="security-tab">
                    <form action="{{ route('landlord.profile.update') }}" class="edit-form" method="POST"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <label class="d-block">@translate('reset_two_factor_authentication')</label>
                                <button class="btn btn-danger reset-factor-authentication"
                                    data-route="{{ route('2fa.reset') }}" type="button">@translate('reset')</button>
                            </div>
                        </div>
                        <hr />
                        <div class="row">
