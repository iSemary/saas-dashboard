        ...
        <div class="col-lg-8">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-6 text-end">
                            <div class="btn-group" role="group">
                                <a href="{{ route('landlord.tickets.edit', $ticketData['ticket']->id) }}" 
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <!-- Comments List -->
                    <div id="commentsList">
                        @include('landlord.ticket.tickets.partials.comments', ['comments' => $ticketData['comments']])
                    </div>
                </div>
            </div>
        </div>
...
<!-- Action Modals -->
@include('landlord.ticket.tickets.modals.assign')
@include('landlord.ticket.tickets.modals.status')
@include('landlord.ticket.tickets.modals.priority')
@endsection

@section('scripts')
<script src="{{ asset('assets/landlord/js/ticket/tickets/show.js') }}"></script>
@endsection
