                                        ...
                                        <div class="d-flex justify-content-between align-items-start mb-2">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li><a class="dropdown-item" :href="'/landlord/tickets/' + ticket.id">
                                                        <i class="fas fa-eye"></i> @translate('view')
                                                    </a></li>
                                                    <li><a class="dropdown-item" :href="'/landlord/tickets/' + ticket.id + '/edit'">
...
@include('landlord.ticket.tickets.modals.comment')
@include('landlord.ticket.tickets.modals.bulk-action')
@endsection

@section('scripts')
<script src="{{ asset('assets/landlord/js/ticket/tickets/kanban.js') }}"></script>
@endsection
