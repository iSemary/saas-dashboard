<div class="card">
    <div class="card-header">
        <div class="row">
            ...
            <div class="col-4 text-right">
                <a href="{{ $id ? route('tenant.activity-logs.index', $id) : route('tenant.activity-logs.index') }}"
    ...
    <div class="card-body">
        <table id="showTable"
            data-route="{{ $id ? route('tenant.activity-logs.modal', $id) : route('tenant.activity-logs.modal') }}"
