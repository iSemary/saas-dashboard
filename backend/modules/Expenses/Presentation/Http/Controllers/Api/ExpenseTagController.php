...
use Modules\Expenses\Presentation\Http\Requests\UpdateExpenseTagRequest;
...
class ExpenseTagController extends Controller
{
    ...
    public function __construct(
        protected ExpenseTagRepositoryInterface $repository,
    ) {}
    ...
    public function store(StoreExpenseTagRequest $request): JsonResponse
    {
    ...
    public function update(UpdateExpenseTagRequest $request, int $id): JsonResponse
    {
        $data = $request->validated();
    ...
    public function bulkDestroy(Request $request): JsonResponse
    {
        ...
        return $this->apiSuccess(['deleted' => $count], "${count} ExpenseTag(s) deleted successfully");
    }
}
