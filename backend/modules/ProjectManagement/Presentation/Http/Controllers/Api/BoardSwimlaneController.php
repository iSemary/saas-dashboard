...
use Modules\ProjectManagement\Infrastructure\Persistence\BoardSwimlaneRepositoryInterface;

class BoardSwimlaneController extends Controller
{
    use ApiResponseEnvelope;

    public function __construct(protected BoardSwimlaneRepositoryInterface $repository) {}
    ...
    {
        $this->repository->reorder($request->input('swimlanes', []));
