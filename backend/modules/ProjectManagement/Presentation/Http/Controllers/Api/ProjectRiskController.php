...
use Modules\ProjectManagement\Infrastructure\Persistence\RiskRepositoryInterface;

class ProjectRiskController extends Controller
{
    use ApiResponseEnvelope;

    public function __construct(protected RiskRepositoryInterface $repository) {}
