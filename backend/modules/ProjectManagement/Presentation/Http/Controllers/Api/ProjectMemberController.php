...
use Modules\ProjectManagement\Infrastructure\Persistence\ProjectMemberRepositoryInterface;

class ProjectMemberController extends Controller
{
    use ApiResponseEnvelope;

    public function __construct(protected ProjectMemberRepositoryInterface $repository) {}
    ...
    public function store(Request $request, string $projectId): JsonResponse
    {
        ...
        return $this->apiSuccess($item, translate('message.action_completed'), 201);
    }
