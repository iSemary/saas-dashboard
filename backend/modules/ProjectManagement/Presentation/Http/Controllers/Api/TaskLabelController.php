...
use Modules\ProjectManagement\Infrastructure\Persistence\LabelRepositoryInterface;

class TaskLabelController extends Controller
{
    use ApiResponseEnvelope;

    public function __construct(protected LabelRepositoryInterface $repository) {}
