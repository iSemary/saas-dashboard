...
use Modules\Accounting\Presentation\Http\Requests\UpdateChartOfAccountRequest;
...
class ChartOfAccountController extends Controller
{
    ...
    public function bulkDestroy(Request $request): JsonResponse
    {
        ...
        return $this->apiSuccess(['deleted' => $count], "${count} ChartOfAccount(s) deleted successfully");
    }
