...
use Modules\Accounting\Presentation\Http\Requests\StoreBankTransactionRequest;
use Modules\Accounting\Presentation\Http\Requests\UpdateBankTransactionRequest;
...
class BankTransactionController extends Controller
{
    ...
    public function update(UpdateBankTransactionRequest $request, int $id): JsonResponse
    {
        $data = $request->validated();
    ...
    public function bulkDestroy(Request $request): JsonResponse
    {
        ...
        return $this->apiSuccess(['deleted' => $count], "${count} BankTransaction(s) deleted successfully");
    }
