...
use Modules\Accounting\Presentation\Http\Requests\UpdateBankAccountRequest;
...
class BankAccountController extends Controller
{
    ...
    public function bulkDestroy(Request $request): JsonResponse
    {
        ...
        return $this->apiSuccess(['deleted' => $count], "${count} BankAccount(s) deleted successfully");
    }
