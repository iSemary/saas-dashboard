...
namespace Modules\EmailMarketing\Application\UseCases\Contact;
...
class EmContactUseCase
{
    public function __construct(
        private readonly EmContactRepositoryInterface $repository,
    ) {}
    ...
    public function create(CreateEmContactDTO $dto)
    {
        return $this->repository->create(array_merge($dto->toArray(), ['created_by' => auth()->id()]));
    }

    public function update(int $id, UpdateEmContactDTO $dto)
    {
