...
class EmailMarketingValueObjectTest extends TestCase
{
    // ── EmCampaignStatus ──────────────────────────────────────────

    public function test_em_campaign_status_values(): void
    {
    ...
    public function test_em_campaign_status_all_cases_covered(): void
    {
        $this->assertCount(6, EmCampaignStatus::cases());
    }

    public function test_em_campaign_status_valid_transitions(): void
    {
        ...
        $this->assertTrue(EmCampaignStatus::Scheduled->canTransitionTo(EmCampaignStatus::Sending));
        $this->assertTrue(EmCampaignStatus::Scheduled->canTransitionTo(EmCampaignStatus::Draft));
        $this->assertTrue(EmCampaignStatus::Sending->canTransitionTo(EmCampaignStatus::Sent));
        $this->assertTrue(EmCampaignStatus::Sending->canTransitionTo(EmCampaignStatus::Paused));
        $this->assertTrue(EmCampaignStatus::Paused->canTransitionTo(EmCampaignStatus::Sending));
    }

    public function test_em_campaign_status_terminal_states(): void
    {
        $this->assertFalse(EmCampaignStatus::Sent->canTransitionTo(EmCampaignStatus::Draft));
        $this->assertFalse(EmCampaignStatus::Cancelled->canTransitionTo(EmCampaignStatus::Draft));
    }

    public function test_em_campaign_status_label(): void
    {
    ...
    public function test_em_contact_status_values(): void
    {
    ...
    public function test_em_contact_status_is_reachable(): void
    {
    ...
    public function test_em_log_status_values(): void
    {
    ...
    public function test_em_log_status_all_cases_covered(): void
    {
    ...
    public function test_em_provider_type_values(): void
    {
    ...
    public function test_em_provider_type_label(): void
    {
