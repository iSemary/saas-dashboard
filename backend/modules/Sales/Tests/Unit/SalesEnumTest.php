...
class SalesEnumTest extends TestCase
{
    // ── OrderStatus ─────────────────────────────────────────────
    ...
    public function test_order_status_from_valid(): void
    {
        $status = OrderStatus::from('completed');
        $this->assertSame(OrderStatus::Completed, $status);
    }
