...
class UpdateEmployeeRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'employment_status' => 'sometimes|required|string|in:' . implode(',', array_column(EmploymentStatus::cases(), 'value')),
            ...
            'pay_frequency' => 'sometimes|required|string|in:' . implode(',', array_column(PayFrequency::cases(), 'value')),
