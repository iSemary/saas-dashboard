...
namespace Modules\SmsMarketing\Application\UseCases\Template;
...
class SmTemplateUseCase
{
    public function __construct(
        private readonly SmTemplateRepositoryInterface $repository,
    ) {}
    ...
    public function create(CreateSmTemplateDTO $dto)
    {
        return $this->repository->create(array_merge($dto->toArray(), ['created_by' => auth()->id()]));
    }

    public function update(int $id, UpdateSmTemplateDTO $dto)
    {
