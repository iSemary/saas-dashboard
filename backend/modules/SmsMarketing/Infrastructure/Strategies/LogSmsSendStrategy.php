...
namespace Modules\SmsMarketing\Infrastructure\Strategies;

use Illuminate\Support\Str;
use Modules\SmsMarketing\Domain\Entities\SmCampaign;
use Modules\SmsMarketing\Domain\Entities\SmContact;
use Modules\SmsMarketing\Domain\Strategies\SmSendingStrategyInterface;
use Modules\SmsMarketing\Domain\ValueObjects\SmLogStatus;

class LogSmsSendStrategy implements SmSendingStrategyInterface
{
