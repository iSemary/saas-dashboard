...
class TranslationApiController extends Controller
{
    ...
    public function store(StoreTranslationRequest $request)
    {
        ...
        return $this->apiSuccess($this->service->create($data), 'Translation created successfully', 201);
    }
    ...
    public function update(UpdateTranslationRequest $request, $id)
    {
        ...
        return $this->apiSuccess($this->service->findOrFail($id), 'Translation updated successfully');
    }

    public function destroy($id)
    {
        $this->service->delete($id);
        return $this->apiSuccess(null, 'Translation deleted successfully');
    }
}
