...
Route::prefix('landlord')->name('landlord.')->middleware(['auth:api', 'landlord_roles', 'throttle:60,1'])->group(function () {
    ...
    Route::apiResource('provinces', ProvinceApiController::class)->except(['show']);
    Route::apiResource('cities', CityApiController::class)->except(['show']);
    Route::apiResource('towns', TownApiController::class)->except(['show']);
    Route::apiResource('streets', StreetApiController::class)->except(['show']);
});
