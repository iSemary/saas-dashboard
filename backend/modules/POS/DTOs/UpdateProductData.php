...
readonly class UpdateProductData
{
    ...
    public static function fromRequest(Request $request): self
    {
        ...
        return new self(
            ...
            sale_price: isset($data['sale_price']) ? (float) str_replace(',', '', (string) $data['sale_price']) : null,
            supplier_id: $data['supplier_id'] ?? null,
            category_id: $data['category_id'] ?? null,
            sub_category_id: $data['sub_category_id'] ?? null,
            is_offer: $isOffer,
            offer_price: $isOffer && isset($data['sale_price']) ? (float) str_replace(',', '', (string) $data['sale_price']) * (1 - ($data['offer_percentage'] ?? 0) / 100) : null,
