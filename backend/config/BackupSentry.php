...
return [
    'backup' => [
        ...
        'compressed_password' => env('BACKUP_SENTRY_ZIP_PASSWORD', 123),
        ...
        'cloud_services' => [
            'google_drive' => [
                'allow' => false,
                'folder_id' => env('BACKUP_SENTRY_GOOGLE_DRIVE_BACKUP_FOLDER_ID', ''), // leave empty if the default value is same as env key : GOOGLE_DRIVE_BACKUP_FOLDER_ID
                'client_id' => env('BACKUP_SENTRY_GOOGLE_DRIVE_CLIENT_ID', ''), // leave empty if the default value is same as env key : GOOGLE_DRIVE_CLIENT_ID
                'refresh_token' => env('BACKUP_SENTRY_GOOGLE_DRIVE_REFRESH_TOKEN', ''), // leave empty if the default value is same as env key : GOOGLE_DRIVE_REFRESH_TOKEN
                'client_secret' => env('BACKUP_SENTRY_GOOGLE_DRIVE_CLIENT_SECRET', ''), // leave empty if the default value is same as env key : GOOGLE_DRIVE_CLIENT_SECRET
            ],
            'aws' => [
                'allow' => true,
        ...
        'mail' => [
            'allow' => true,
            'to' => [env('BACKUP_SENTRY_ALERT_MAILS', '')]
        ],
        ...
        'channels' => [
            ...
            'slack' => [
                'allow' => true,
                'webhook_url' => env('BACKUP_SENTRY_SLACK_WEBHOOK_URL', '') // you can create a new app on slack OR leave empty if the default value is same as env key : SLACK_WEBHOOK_URL
            ],
