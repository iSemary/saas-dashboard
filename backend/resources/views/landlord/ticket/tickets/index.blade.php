...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table id="table" data-route="{{ route('landlord.tickets.index') }}"
    ...
    <!-- Bulk Action Modals -->
    @include('landlord.ticket.tickets.modals.bulk-assign')
    @include('landlord.ticket.tickets.modals.bulk-status')
    @include('landlord.ticket.tickets.modals.bulk-priority')
@endsection

@section('scripts')
    <script src="{{ asset('assets/landlord/js/ticket/tickets/index.js') }}"></script>
@endsection
